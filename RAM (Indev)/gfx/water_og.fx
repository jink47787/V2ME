...
float4 PixelShader_Far( VS_OUTPUT_WATER_FAR IN ) : COLOR
{
    ...
    // Blend more heavily towards the parchment color for a more washed-out look
    float3 blendedColor = lerp(baseColor.rgb, parchmentColor, 0.8);
    ...
    blendedColor = saturate(blendedColor * 1.1);
